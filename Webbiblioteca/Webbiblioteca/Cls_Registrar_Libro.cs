...
{
    public class Cls_Registrar_Libro
    {
        private string str_mensaje;
        Cls_Conexion objConexion = new Cls_Conexion();
        public void fnt_Crear(string isbn, string Nombre, string autor, string editoreal, int N_paginas, string genero,string fecha_p, int estado,  int Cantidad_ejem)
        {
            ...
            else
            {
                ...
                SqlCommand con = new SqlCommand("SP_RegistrarLibro", objConexion.connection);
                ...
                str_mensaje = "El libro" + Nombre + "de" + "" +  autor + "fue registrado con exito";
